...
class StocksFlowE2eTest {

  @TestConfiguration
  static class StocksTestConfig {
    /*
      The stocks module orchestrates simulation during stock retrieval
      (StockPriceTickService injects both CatalogPort and PriceEnginePort).
  ...
  void getStocksReturnsAllTenWithMetadata() {
    var result =
        restTestClient
            ...
            .expectStatus()
            .isOk()
            .returnResult(MarketStocksResponse.class);
