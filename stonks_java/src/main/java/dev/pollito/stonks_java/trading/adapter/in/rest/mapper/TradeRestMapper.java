package dev.pollito.stonks_java.trading.adapter.in.rest.mapper;
...
public interface TradeRestMapper {
  ...
  default dev.pollito.stonks_java.trading.domain.TradeAction map(TradeAction action) {
    return action == null
        ? null
        : EnumUtils.fromValue(
            dev.pollito.stonks_java.trading.domain.TradeAction.class, action.getValue());
  }
